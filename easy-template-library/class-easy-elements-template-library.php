	...
	public function easy_editor_footer_script() { ?>
		<script type="text/javascript">
            ...
            var rtElementsTemplatesManager = {
                ...
                "buttonIcon": "<?php echo  esc_url( $this->assets_url . 'img/easy-template-logo.webp' ); ?>",
                "logoUrl": "<?php echo  esc_url( $this->assets_url . 'img/easy-template-logo-sm.webp' ); ?>",
                "headerLogoUrl": "<?php echo  esc_url( $this->assets_url . 'img/easy-template-logo.webp' ); ?>",
                "bannerAdUrl": "<?php echo  esc_url( $this->assets_url . 'img/easy-templates-banner-ad.webp' ); ?>",
